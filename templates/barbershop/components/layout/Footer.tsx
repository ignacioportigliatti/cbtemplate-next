        ...
        <Container className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12">
            ...
            <div className="space-y-4">
              <h5 className="font-medium text-base text-text font-heading tracking-[0.2em] uppercase">Menu</h5>
              <div className="space-y-2">
            ...
            {/* Column 3: Blog */}
            <div className="space-y-4">
              <h5 className="font-medium text-base text-text font-heading tracking-[0.2em] uppercase">Blog</h5>
              <div className="space-y-2">
                <Link href="/blog" className="block text-muted-foreground/70 hover:text-primary transition-colors text-sm tracking-[0.1em] uppercase">
                  All Posts
                </Link>
            ...
            <div className="space-y-6">
              {/* Locations Section */}
              <div className="space-y-4">
                <h5 className="font-medium text-base text-text font-heading tracking-[0.2em] uppercase">Locations</h5>
                <div className="space-y-2">
              ...
              <div className="space-y-4">
                {customPages && customPages.length > 0 && (
                  <h5 className="font-medium text-base text-text font-heading tracking-[0.2em] uppercase">Other Pages</h5>
                )}
                <div className="space-y-2">
