  ...
  return (
    <Section className="pt-24 md:pt-32 bg-background-900 pb-16">
      <Container className="max-w-7xl mx-auto px-8 xl:px-0">
        ...
        <p className="text-muted-foreground/80 text-center mt-1 md:text-left w-full">
        ...
        {serviceData.service_page_content && (
          <div className="mt-2 w-full max-w-none prose-strong:text-text prose prose-h1:text-4xl prose-headings:text-text prose-p:text-text prose-li:text-text prose-headings:font-heading prose-headings:text-3xl prose-h1:font-heading prose-h1:text-primary prose-h1:leading-[0.9] prose-h1:font-bold " dangerouslySetInnerHTML={{ __html: serviceData.service_page_content }} />
        )}
